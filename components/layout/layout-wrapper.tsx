...
export function LayoutWrapper({
  ...
  return (
    <>
      <div className="flex flex-col lg:flex-row min-h-screen w-full bg-background/40 backdrop-blur-sm border-x border-border/50">
        ...
        <main className="flex-1 min-h-screen min-w-0">
          <div className="w-full py-8 lg:py-12 px-4 lg:px-6">{children}</div>
        </main>
      </div>
