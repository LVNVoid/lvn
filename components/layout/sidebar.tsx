...
export function Sidebar({ className, onNavigate, profile }: SidebarProps) {
  ...
  return (
    <aside
      className={cn(
        'sticky top-0 z-40 h-screen w-72 border-r border-border/40 p-6 hidden lg:flex flex-col gap-6',
        className,
      )}
    >
      ...
      <div className="flex flex-col gap-4 mt-auto">
        <Button
          variant="outline"
          className="w-full justify-start gap-2 border-primary/20 hover:bg-primary/10 hover:text-primary transition-all group"
        >
